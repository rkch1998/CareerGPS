...
@Entity
@Table(name = "assessment_answers", uniqueConstraints = @UniqueConstraint(name = "uk_assessment_question", columnNames = {"assessment_id", "question_id"}))
...
public class AssessmentAnswer {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "option_id", nullable = false) private QuestionOption option;
