...
public class QuestionController {
    ...
    @GetMapping
    public List<QuestionDTO> getQuestions() { return questionService.getActiveQuestions(); }

    @GetMapping("/{id}")
    public QuestionDTO getQuestion(@PathVariable Long id) { return questionService.getQuestion(id); }
}
