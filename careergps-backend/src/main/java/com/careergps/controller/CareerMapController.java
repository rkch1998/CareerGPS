...
public class CareerMapController {
    ...
    public CareerMapController(CareerMapService careerMapService) { this.careerMapService = careerMapService; }
    @GetMapping("/{careerId}") public List<RouteDTO> getRoutes(@PathVariable Long careerId) { return careerMapService.getRoutes(careerId); }
}
